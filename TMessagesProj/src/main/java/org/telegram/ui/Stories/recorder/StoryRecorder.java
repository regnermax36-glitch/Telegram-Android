...
//                    captionEdit.editText.hideEmojiView();
    ...
    private class ContainerView extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            int previewW_card = previewW - dp(24);
            int l = (previewW - previewW_card) / 2;
            previewContainer.layout(l, 0, l + previewW_card, previewH);
            previewContainer.setPivotX(previewW_card * .5f);
            actionBarContainer.layout(l, t, l + previewW_card, t + actionBarContainer.getMeasuredHeight());
            controlContainer.layout(l, previewH - controlContainer.getMeasuredHeight(), l + previewW_card, previewH);
            navbarContainer.layout(l, previewH, l + previewW_card, previewH + navbarContainer.getMeasuredHeight());
            captionContainer.layout(l, 0, l + previewW_card, previewH);
            ...
            if (captionEdit.mentionContainer != null) {
                captionEdit.mentionContainer.layout(l, 0, l + previewW_card, previewH);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int previewW_card = previewW - dp(24);
            measureChildExactly(previewContainer, previewW_card, previewH);
            applyFilterMatrix();
            measureChildExactly(actionBarContainer, previewW_card, dp(56 + 56 + 38));
            measureChildExactly(controlContainer, previewW_card, dp(220));
            measureChildExactly(navbarContainer, previewW_card, underControls);
            measureChildExactly(captionContainer, previewW_card, previewH);
        ...
        protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
            ...
            if (child == previewContainer) {
                ...
                int previewW_card = previewW - dp(24);
                int l = (previewW - previewW_card) / 2;
                AndroidUtilities.rectTmp.set(l, 0, l + previewW_card, dp(72 + 12) + top);
    ...
    private BlurringShader.StoryBlurDrawer previewBlur;
    ...
    private void initViews() {
        ...
        containerView.addView(previewContainer = new FrameLayout(context) {
            ...
            protected void dispatchDraw(@NonNull Canvas c) {
                if (previewBlur == null) {
                    previewBlur = new BlurringShader.StoryBlurDrawer(blurManager, this, BlurringShader.StoryBlurDrawer.BLUR_TYPE_IOS28);
                    previewBlur.setRoundRadius(dp(32));
                    blurManager.updateParents();
                }
        ...
        containerView.addView(actionBarContainer = new FrameLayout(context) {
            ...
            protected void dispatchDraw(Canvas canvas) {
                if (actionBarBlur == null) {
                    actionBarBlur = new BlurringShader.StoryBlurDrawer(blurManager, this, BlurringShader.StoryBlurDrawer.BLUR_TYPE_IOS28);
                    actionBarBlur.setRoundRadius(dp(32));
                    blurManager.updateParents();
                }
                canvas.save();
                AndroidUtilities.rectTmp.set(0, 0, getWidth(), getHeight());
        ...
        containerView.addView(controlContainer = new FrameLayout(context) {
            ...
            protected void dispatchDraw(Canvas canvas) {
                if (controlBlur == null) {
                    controlBlur = new BlurringShader.StoryBlurDrawer(blurManager, this, BlurringShader.StoryBlurDrawer.BLUR_TYPE_IOS28);
                    controlBlur.setRoundRadius(dp(32));
                    blurManager.updateParents();
                }
                canvas.save();
                AndroidUtilities.rectTmp.set(0, 0, getWidth(), getHeight());
...
//            requestedCameraPermission = false;
    ...
    public ImageView getThemeButton() {
        if (themeButton == null) {
            ...
            themeButton.setScaleX(0.85f);
            themeButton.setScaleY(0.85f);
