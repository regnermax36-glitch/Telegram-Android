...
public class StoryModeTabs extends FrameLayout implements FlashViews.Invertable {
    ...
    public StoryModeTabs(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 21) live.setLetterSpacing(0.05f);
        ...
        if (Build.VERSION.SDK_INT >= 21) photo.setLetterSpacing(0.05f);
        ...
        if (Build.VERSION.SDK_INT >= 21) video.setLetterSpacing(0.05f);
