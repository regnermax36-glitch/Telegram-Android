    ...
    public StoryModeTabs(Context context) {
        ...
        layout = new LinearLayout(context) {
            ...
            protected void dispatchDraw(@NonNull Canvas canvas) {
                ...
                canvas.drawRoundRect(c, dp(16), dp(16), backgroundPaint);
        ...
        if (android.os.Build.VERSION.SDK_INT >= 21) live.setLetterSpacing(0.05f);
        ...
        if (android.os.Build.VERSION.SDK_INT >= 21) photo.setLetterSpacing(0.05f);
        ...
        if (android.os.Build.VERSION.SDK_INT >= 21) video.setLetterSpacing(0.05f);
