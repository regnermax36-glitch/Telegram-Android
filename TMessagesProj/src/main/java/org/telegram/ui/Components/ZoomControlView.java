...
public class ZoomControlView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isPortrait) {
            ...
            progressDrawable.setBounds(progressStartY, 0, progressEndY, AndroidUtilities.dp(1));
            filledProgressDrawable.setBounds(progressStartY, 0, knobY, AndroidUtilities.dp(1));
            canvas.save();
            canvas.rotate(90);
